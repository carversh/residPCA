...
# %%
metadata = pd.read_csv('../../Simulation/METADATA_{}_{}_{}_{}_{}_gene_{}_cell_{}_flag_{}.txt'.format(
    args.method,
    args.total_cells,
    args.seed,
    args.state_type,
...
# %%
my_method_light = residPCA(count_matrix_path='../../Simulation/{}_{}_{}_{}_{}_gene_{}_cell_{}_flag_{}.txt'.format(
    args.method,
    args.total_cells,
    args.seed,
    args.state_type,
...
metadata_path='../../Simulation/METADATA_{}_{}_{}_{}_{}_gene_{}_cell_{}_flag_{}.txt'.format(
    args.method,
    args.total_cells,
    args.seed,
    args.state_type,
...
if args.state_type == "within_one_ct":
    SUB_resid_max_corr = max_correlation_compute_SUB(my_method_light.residPCA_cell_embeddings)
